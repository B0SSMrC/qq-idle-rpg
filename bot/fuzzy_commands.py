...
_RULES: tuple[_AliasRule, ...] = (
    ...
    _AliasRule("world_boss_attack", "进攻世界boss", no_arg_only=False, fuzzy=False),
    _AliasRule("world_boss_attack", "攻击世界boss", no_arg_only=False, fuzzy=False),
    _AliasRule("world_boss_attack", "挑战世界boss", no_arg_only=False, fuzzy=False),
    _AliasRule("world_boss_attack", "打世界boss", no_arg_only=False, fuzzy=False),
    _AliasRule("world_boss_attack", "进攻boss", no_arg_only=False, fuzzy=False),
    ...
    _AliasRule("void_sacrifice", "十连献祭", no_arg_only=True, fuzzy=False, fixed_arg="10"),
    _AliasRule("void_sacrifice", "献祭十连", no_arg_only=True, fuzzy=False, fixed_arg="10"),
